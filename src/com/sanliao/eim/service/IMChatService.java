package com.sanliao.eim.service;
...
public class IMChatService extends Service {
	private final static String LOG_TAG="IMChatService";
	private Context context;
	private NotificationManager notificationManager;

	@Override
	public void onCreate() {//第一次拉起服务的时候被调用
...
//监听包的到来
	PacketListener pListener = new PacketListener() {
		...
		@Override
		public void processPacket(Packet arg0) {//如何处理来的数据包
			...
			if (message != null && message.getBody() != null
				...
				String time = DateUtil.date2Str(Calendar.getInstance(),
						Constant.MS_FORMART);//时间
				msg.setTime(time);
				msg.setContent(message.getBody());//设置内容
