...
import com.sanliao.eim.service.IMChatService;
...
public class ActivitySupport extends Activity implements IActivitySupport {
	private final static String LOG_TAG="ActivitySupport";
	...
	public LoginConfig getLoginConfig() {
		...
		Log.d(LOG_TAG, getResources().getString(R.string.xmpp_service_name));
		...
		String str=loginConfig.getXmppServiceName();
		Log.d(LOG_TAG, str);
